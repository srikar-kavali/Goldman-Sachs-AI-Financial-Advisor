...
// ── Mini donut for portfolio breakdown ────────────────────────────────
function MiniDonut() {
    return (
        <svg viewBox="0 0 36 36" className="t-donut">
            <circle cx="18" cy="18" r="14" fill="none" stroke="#e3e6ec" strokeWidth="6" />
            <circle cx="18" cy="18" r="14" fill="none" stroke="#3465f4" strokeWidth="6"
                    strokeDasharray="39.6 48" strokeDashoffset="0" />
            <circle cx="18" cy="18" r="14" fill="none" stroke="#2f3848" strokeWidth="6"
                    strokeDasharray="22 88" strokeDashoffset="-39.6" />
            <circle cx="18" cy="18" r="14" fill="none" stroke="#20a7e3" strokeWidth="6"
                    strokeDasharray="13 88" strokeDashoffset="-61.6" />
        </svg>
    );
}

// ── Main Component ────────────────────────────────────────────────────
export default function TradingPage({ onNavigate }) {
    ...
    return (
        <main className="page t-page">
            ...
            <div className="t-main-grid">
                ...
                <div className="t-left-col">
                    ...
                    <div className="t-chart-controls">
                        {TIMEFRAMES.map(tf => (
                            <button
                                key={tf}
                                className={`t-time-btn${timeframe === tf ? ' active' : ''}`}
                    ...
                    <div className="t-order-panel">
                        ...
                        <div className="t-form-actions">
                            <button
                                className={`t-btn-order${side === 'sell' ? ' sell' : ''}`}
                                onClick={placeOrder}
                            >
                ...
                {/* ── Right: Watchlist + Positions + Trades ── */}
                    ...
                    <div className="t-panel">
                        ...
                        <div className="t-watchlist">
                            {watchlist.map(s => (
                                <div
                                    key={s.ticker}
                                    className={`t-watch-item${s.ticker === selectedTicker ? ' selected' : ''}`}
