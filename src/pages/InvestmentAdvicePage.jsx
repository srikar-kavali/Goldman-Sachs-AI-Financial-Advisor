...
const RECOMMENDATIONS = [
    { title: 'Increase Bond Allocation', priority: 'high', category: 'Portfolio Rebalancing', desc: 'Based on current market volatility and your risk profile, consider increasing your bond allocation by 5–10% to provide more stability.', impact: '+2.1% stability', timeline: 'Next 30 days' },
    { title: 'Diversify Into International Markets', priority: 'medium', category: 'Diversification', desc: 'Your portfolio is heavily concentrated in US stocks. Consider allocating 15–20% to international markets for better diversification.', impact: '+1.2% expected return', timeline: 'Next 60 days' },
    { title: 'Review High-Fee Mutual Funds', priority: 'medium', category: 'Cost Optimization', desc: "You're paying 1.2% in fees for several mutual funds. Consider switching to low-cost index funds to reduce expenses.", impact: '$840/yr savings', timeline: 'Next 14 days' },
    { title: 'Tax-Loss Harvesting Opportunity', priority: 'low', category: 'Tax Optimization', desc: 'You have unrealized losses in GOOGL. Consider tax-loss harvesting to offset capital gains and reduce your tax liability.', impact: '$450 tax savings', timeline: 'Before year end' },
];
...
export default function InvestmentAdvicePage({ onNavigate, TopNav }) {
                            ...
                            {RECOMMENDATIONS.map((r, i) => (
                                <div key={i} className="ia-rec-item">
                                    <div className="ia-rec-header">
                                        ...
                                        <span className="ia-rec-badge" style={{ color: priorityColors[r.priority], background: priorityColors[r.priority] + '18', borderColor: priorityColors[r.priority] + '44' }}>
                        ...
                        <div className="ia-panel">
                            ...
                            {analysisTab === 'allocation' ? (
                                <div className="ia-allocation-layout">
                                    <div className="ia-donut-wrap"><AllocationDonut /></div>
                    ...
                    <div className="ia-right-col">
                        <div className="ia-panel ia-ai-panel">
                            ...
                            <div className="ia-chat-input-row">
                                <input type="text" className="ia-chat-input" placeholder="Ask AI Advisor..." value={aiInput} onChange={e => setAiInput(e.target.value)} onKeyDown={e => e.key === 'Enter' && askAI()} />
